      ...
      <div className={styles.split}>
        <div className={styles.left}>
          ...
          <div className="btn-ro row no-margin">
              ...
              <i className="fas fa-user"></i> Mais sobre mim
              </button>
          </div>
        </div>
                  ...
                  <div className="row">
                      <div className="col-md-4 left-co">
                          <div className="left-side">
                              ...
                              <h4 className="ltitle">Contato</h4>
                              ...
                              <h4 className="ltitle">Contato / Links Sociais</h4>
                              ...
                              <h4 className="ltitle">Idiomas</h4>
                              ...
                              <h4 className="ltitle">Principais tecnologias</h4>
                      ...
                      <div className="col-md-8 rt-div">
                          <div className="rit-cover">
                              ...
                              <h2 className="rit-titl"><i className="fas fa-crosshairs"></i> Objetivo</h2>
                              <div className="about">
                                  <p>{bio.objective}</p>
                              </div>

                              <h2 className="rit-titl"><i className="far fa-user"></i> Perfil</h2>
                              <div className="about">
                                  ...
                                  <div className="btn-ro row no-margin">
                                      <ul className="btn-link">
                                          <li>
                                              ...
                                              <button className="side-btn" onClick={()=>{alert("Ótimo!\nVocê será redirecionado para a página de contato. Obrigado :)");window.open("https://www.sthefanoc.com/contact")}}>
                                                <i className="fas fa-paper-plane"></i> Me contrate
                                            </button>
                                          ...
                                          <li>
                                              <button className="side-btn" onClick={()=>{window.open("https://www.sthefanoc.com/projects")}}>
                                                <i className="fas fa-laptop-code"></i> Meus projetos
                                            </button>
                                          </li>
                                      </ul>
                                  </div>
                              ...
                              <h2 className="rit-titl"><i className="fas fa-code"></i> Projetos</h2>
                              <ul className="projects">
                                  {projects.map((project) => (
                                      <li className="project-item">
                                          <div className="project-description">
                                            <a href={project.liveProject} target="_blank" rel="noopener noreferrer" className="title">
                                                <h6>{project.title}</h6>
                                            </a>
                              ...
                              <h2 className="rit-titl pagebreak"><i className="fas fa-briefcase"></i> Experiência Profissional</h2>
                              ...
                              <h2 className="rit-titl"><i className="fas fa-graduation-cap"></i> Educação</h2>
